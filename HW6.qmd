...
Out of all of these paths, we see that there are no mediators, colliers, or descendants in this DAG. We see confounders Age and Smoking. Therefore adding Age and Smoking as a co-variate would allow us to condition on these confounders and observe an unbiased estimate for the association between HIV and Stroke.
