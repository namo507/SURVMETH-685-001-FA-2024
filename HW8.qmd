...
# 1.A. Kappa and Condition Numbers
```{r}
...
# 1.B. Correlations between predictors
cor_matrix <- round(cor(prostate[,-9]), 3)  # Excluding lpsa
print(cor_matrix)

# 1.C. Variance Inflation Factors
vif_values <- vif(model)
print(vif_values)

# Question 2: Cars Dataset Analysis
data(cars)

# 2.A. Homoscedasticity Tests
...
# 2.B. Heteroscedastic Consistent Variance
...
# 2.D. Lack of Fit Test
# Create groups based on unique speed values
